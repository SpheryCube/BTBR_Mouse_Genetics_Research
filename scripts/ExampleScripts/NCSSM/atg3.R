...
f2g$pheno <- cbind(f2g$pheno[,c("MouseNum","Sex","pgm")],phenotypes.rz[,c("GLU.10wk","INS.10wk","TRIG.10wk","HOMA.10wk")],  park2_islet, iapp_islet, pink1_islet,  atg5_liver, atg7_liver,atg7_islet, atg5_islet)
...
scan1 <- scanone(f2g,  pheno.col = c("GLU.10wk","INS.10wk","TRIG.10wk","HOMA.10wk", "park2_islet", "iapp_islet", "pink1_islet", "atg5_liver", "atg7_liver", "atg5_islet", "atg7_islet"), method = "hk", addcovar = sex)
...
plot(scan1, lodcolumn = 5, main = "Quantitative Trait Loci for Parkin Expression in Pancreatic Islet")
