...
grep("Chst1$", annot$gene1)
which(annot$gene_symbol=="Chst1$")
...
out2 <-c.qtlnet(outs.qtlnet) # catenates the outputs from 3 separate runs together
summary(out2)
plot(out2)
#jpeg('QTLnet-Il6-Insulin.jpg')
